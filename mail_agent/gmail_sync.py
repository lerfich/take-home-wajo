...
def local_data_counts(db):
    groups = {
        ...
        "feedback": ("preference_feedback", "label_feedback", "attention_feedback",
                     "organization_feedback", "draft_style_feedback", "archive_skill_feedback"),
        "skills": ("skills", "archive_skills"),
        ...
        "supporting_state": ("label_conflicts", "label_targets", "skill_examples",
                             ...
                             "attention_items", "label_reviews", "archive_decisions"),
        "audit": ("audit",),
    }
...
def clear_local_data(db):
    ...
    tables = (
        ...
        "superpower_applications", "superpower_settings",
        "gmail_operations", "gmail_replies", "archive_skill_feedback", "archive_skills",
        "archive_decisions", "label_conflicts", "label_targets",
