...
A separate read-only review of Events, Event Skills, Calendar UI, Models and notifications found defects that the first 242-test pass did not expose. The fixes and new regressions bring the full suite to **247 passing tests**.
